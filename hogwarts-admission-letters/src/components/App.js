...
class App extends React.Component {
  ...
  handleCheckboxChange(event) {
    ...
    //apparently bad form but works should move into out function
    // this.setState({checked: !this.state.isChecked})
  ...
  render() {
    ...
    if (this.state.isChecked === true){
         content =  <RejectionLetterText />
         console.log(this.state.isChecked,'rejected', content)

    }else {
       content = <AcceptanceLetterText />
       console.log(this.state.isChecked,'accepted', content)
    }
